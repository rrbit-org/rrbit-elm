...
--                below are performing great! ignore for now
...
--                below are broken, ignore for now
...
--              , Benchmark.compare "member"
--                (benchmark1 "Array" Array.member (size / 2) sampleArray)
--                (benchmark1 "Vector" Vector.member (size / 2) sampleVector)
            ]